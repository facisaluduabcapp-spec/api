...
<div
  style={{
    ...
    gap: "1rem", // 👉 separa elementos al romper línea
  }}
>
  ...
  <div style={{ flexShrink: 0 }}>
    <button
      ...
      style={{
        ...
        transition: "all 0.3s",
        width: "100%",
        maxWidth: "200px", // 👉 evita que crezca demasiado
      }}
      onMouseEnter={(e) => {
        e.target.style.background = "#667eea";
        e.target.style.color = "white";
  ...
  <div>
    <div
      style={{
        ...
        alignItems: "center",
        marginBottom: "1.5rem",
        flexWrap: "wrap", // 👉 evita desbordes
        gap: "1rem", // 👉 espacio cuando salta de línea
      }}
    >
      <h2
        style={{
      ...
      >
        ...
        <div
          style={{
            ...
            justifyContent: "space-between",
            alignItems: "center",
            flexWrap: "wrap", // 👉 para dispositivos pequeños
            gap: "1rem",
          }}
        >
          <button
            ...
            style={{
              ...
              display: "flex",
              alignItems: "center",
              minWidth: "230px", // 👉 evita que se colapse
            }}
          >
            <div
              style={{
                ...
                height: "45px",
                background:
                  "linear-gradient(135deg, #667eea 0%, #204194 100%)",
                borderRadius: "50%",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
          ...
          <div
            style={{
              ...
              gap: "0.5rem",
              alignItems: "center",
              flexWrap: "wrap", // 👉 botones se apilan en móvil
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: "40px",
                background:
                  deletingUser === usuario.userId ? "#adb5bd" : "#dc3545",
                color: "white",
                border: "none",
                borderRadius: "10px",
                cursor:
                  deletingUser === usuario.userId ? "not-allowed" : "pointer",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                transition: "all 0.3s",
            ...
            >
              <FontAwesomeIcon
                icon={
                  deletingUser === usuario.userId ? faSpinner : faTrash
                }
                spin={deletingUser === usuario.userId}
                style={{ fontSize: "1rem" }}
              />
